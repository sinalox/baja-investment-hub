  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Premium variants for real estate site
        gold: "bg-accent text-accent-foreground font-medium shadow-lg hover:scale-[1.02] hover:brightness-105",
        heroOutline: "border-2 border-white/80 text-white bg-transparent font-medium hover:bg-white hover:text-foreground",
        heroPrimary: "bg-accent text-accent-foreground font-semibold shadow-lg hover:scale-[1.02] hover:brightness-105 tracking-wide",
        dark: "bg-charcoal text-white font-medium hover:bg-charcoal/90",
      },
      size: {
